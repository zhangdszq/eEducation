...
//    private static List<MessageListBean> messageListBeanList = new ArrayList<>();
    private static List<MsgBean> messageListBeanList = new ArrayList<>();
...
//    }
//
//    public static void addMessageBean(String account, String msgArgs) {
//        MessageBean messageBean = new MessageBean(account, msgArgs, false);
