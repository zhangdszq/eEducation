...
//                if ("ChannelMessage".equals(object.getString("name"))) {
//
//                    final ChannelMessage msgArgs = new Gson().fromJson(s, ChannelMessage.class);
//                    runOnUiThread(new Runnable() {
//                        @Override
//                        public void run() {
//                            onMessageUpdate(msgArgs);
//                        }
//                    });
//                }
            ...
            if (TextUtils.equals(peerId, UserConfig.getRtmServerId())) {
                try {
                    ...
                    if ("JoinSuccess".equals(name)) {
                        ...
                        notifyUpdateMembers();
                    } else if (Mute.MUTE.equals(name) || Mute.UN_MUTE.equals(name)) {
                        ...
                        if (args != null && !TextUtils.isEmpty(args.uid) && !TextUtils.isEmpty(args.type)) {
                            final RtmRoomControl.UserAttr userAttr = UserConfig.getUserAttrByUserId(args.uid);

                            boolean isMute = (Mute.MUTE.equals(mute.name));
