...
public class LargeClassActivity extends BaseActivity {
        ...
        public void onMessageReceived(P2PMessage p2PMessage, String peerId) {
            switch (p2PMessage.cmd) {
                ...
                case IMCmd.ACCEPT:
                    ...
                    break;
                case IMCmd.REJECT:
                    runOnUiThread(() -> mWhiteboardFragment.acceptLink(false));
                    break;
    ...
    private void initCommonUI() {
        ...
        mIcExit.setOnClickListener(v -> showLeaveDialog());

        mVideoItemStudent.setOnClickAudioListener(v -> {
        ...
        mVideoItemStudent.setOnClickVideoListener(v -> {
